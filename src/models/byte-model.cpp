...
ByteModel::ByteModel(const std::vector<bool>& vocab, bool track_expected)
    : ex(0), top_(255), mid_(0), bot_(0), vocab_(vocab),
      probs_(1.0 / 256, 256), track_expected_(track_expected) {}
