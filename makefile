...
slow: src/preprocess/preprocessor.cpp src/preprocess/preprocessor.h src/preprocess/dictionary.cpp src/preprocess/dictionary.h src/preprocess/symbols.cpp src/preprocess/symbols.h
	$(CC) $(CPPFLAGS_PART-THAT-CAN-BE-SLOW) src/preprocess/preprocessor.cpp src/preprocess/dictionary.cpp src/preprocess/symbols.cpp -c

fast: src/coder/decoder.cpp src/coder/decoder.h src/coder/encoder.cpp src/coder/encoder.h src/context-manager.cpp src/context-manager.h src/contexts/bit-context.cpp src/contexts/bit-context.h src/contexts/bracket-context.cpp src/contexts/bracket-context.h src/contexts/combined-context.cpp src/contexts/combined-context.h src/contexts/context-hash.cpp src/contexts/context-hash.h src/contexts/context.h src/contexts/indirect-hash.cpp src/contexts/indirect-hash.h src/contexts/interval-hash.cpp src/contexts/interval-hash.h src/contexts/interval.cpp src/contexts/interval.h src/contexts/numeric-sequence-context.cpp src/contexts/numeric-sequence-context.h src/contexts/url-context.cpp src/contexts/url-context.h src/contexts/structural-class.h src/contexts/sparse.cpp src/contexts/sparse.h src/models/conditional-indirect.h src/models/gated-model.h src/models/url-residual.h src/models/bracket.cpp src/models/bracket.h src/models/byte-model.cpp src/models/byte-model.h src/models/direct-hash.cpp src/models/direct-hash.h src/models/direct.cpp src/models/direct.h src/models/indirect.cpp src/models/indirect.h src/models/match.cpp src/models/match.h src/models/model.h src/models/fxcmv1.h src/models/ppmd.cpp src/models/ppmd.h src/states/nonstationary.cpp src/states/nonstationary.h src/states/run-map.cpp src/states/run-map.h src/states/state.h src/mixer/byte-mixer.cpp src/mixer/byte-mixer.h src/mixer/lstm-layer.h src/mixer/lstm.h src/mixer/mixer-input.cpp src/mixer/mixer-input.h src/mixer/mixer.cpp src/mixer/mixer.h src/mixer/sigmoid.cpp src/mixer/sigmoid.h src/mixer/sse.cpp src/mixer/sse.h src/predictor.h src/predictor.cpp src/runner.cpp
	$(CC) $(CPPFLAGS_PART-THAT-SHOULD-BE-FAST) src/coder/decoder.cpp src/coder/encoder.cpp src/context-manager.cpp src/contexts/bit-context.cpp src/contexts/bracket-context.cpp src/contexts/combined-context.cpp src/contexts/context-hash.cpp src/contexts/indirect-hash.cpp src/contexts/interval-hash.cpp src/contexts/interval.cpp src/contexts/numeric-sequence-context.cpp src/contexts/url-context.cpp src/contexts/sparse.cpp src/models/bracket.cpp src/models/byte-model.cpp src/models/direct-hash.cpp src/models/direct.cpp src/models/indirect.cpp src/models/match.cpp src/models/fxcmv1.cpp src/models/ppmd.cpp src/states/nonstationary.cpp src/states/run-map.cpp src/mixer/byte-mixer.cpp src/mixer/mixer-input.cpp src/mixer/mixer.cpp src/mixer/sigmoid.cpp src/mixer/sse.cpp -c src/predictor.cpp src/runner.cpp

cmix: fast slow
	$(CC) $(LFLAGS) bit-context.o bracket-context.o bracket.o byte-mixer.o byte-model.o combined-context.o context-hash.o context-manager.o decoder.o dictionary.o direct-hash.o direct.o encoder.o indirect-hash.o indirect.o interval-hash.o interval.o match.o mixer-input.o mixer.o nonstationary.o numeric-sequence-context.o url-context.o fxcmv1.o ppmd.o predictor.o preprocessor.o symbols.o run-map.o runner.o sigmoid.o sparse.o sse.o -s -o cmix
	rm -f *.o
...
clean:
	...
	rm -f cmix
	rm -f remap
	rm -f url-context-test
	rm -f url-residual-test

all: cmix remap

url-context-test: tests/url-context-test.cpp src/contexts/url-context.cpp src/contexts/url-context.h src/preprocess/symbols.cpp src/preprocess/symbols.h
	$(CC) -std=c++17 -Wall -Wextra -Werror tests/url-context-test.cpp src/contexts/url-context.cpp src/preprocess/symbols.cpp -o url-context-test
	./url-context-test

url-residual-test: tests/url-residual-test.cpp src/models/url-residual.h src/mixer/sigmoid.cpp src/mixer/sigmoid.h
	$(CC) -std=c++17 -Wall -Wextra -Werror tests/url-residual-test.cpp src/mixer/sigmoid.cpp -o url-residual-test
	./url-residual-test
